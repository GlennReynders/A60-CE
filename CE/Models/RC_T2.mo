within CE.Models;
model RC_T2 "2Zone RC model for Annex T2"
...
parameter Real abs5WD =  0;
 ...
 parameter Real     CwD =  1.393E+07;
 parameter Real     CwiD =  1.972E+07;
 parameter Real     CflD =  2.45E+07;
 ...
 parameter Real     hwD =  57.13888889;
 parameter Real     hflD =  120.490081;
 parameter Real     hwiD =  315.2848299;
 parameter Real     infD =  19.36663083;
 parameter Real     UwD =  63.1318388;
 parameter Real     UflD =  413.3479167;
...
parameter Real abs5WN = 0;
 ...
 parameter Real     CwN =  1.100E+07;
 parameter Real     CwiN =  7.254E+07;
 parameter Real     f1N =  0.1;
 parameter Real     f2N =  0.1;
 parameter Real     f3N =  0.7;

 parameter Real     hwN =  58.17385502;
 parameter Real     hwiN =  901.8707643;
 parameter Real     infN =  30.68539764;
 parameter Real     UwN =  261.5801274;

 parameter Real     CfiD =  13760584.35;
 parameter Real     CfiN =  13760584.35;
 parameter Real     f5D =  0.1;
 parameter Real     f5N =  0.1;
 parameter Real     UfDN =  139.7410327;
