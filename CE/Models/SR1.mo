within CE.Models;
model SR1 "Semi-Detached house on the right side of the block, state 1"
...
//protected
  ...
  IDEAS.Buildings.Components.OuterWall walls_N[3](
    each insulationThickness=0,AWall={N_Awall_south,N_Awall_west,N_Awall_north},
    redeclare CE.Data.Constructions.State1.S1Wall constructionType,
  ...
  IDEAS.Buildings.Components.SlabOnGround floor_D(
    each insulationThickness=0,inc=0,
    azi=0,
...
equation
  ...
  connect(flowPort_In[1], dayzone.flowPort_In) annotation (Line(
      points={{20,93.3333},{20,25},{92,25},{92,-50}},
      color={0,0,0},
      smooth=Smooth.None));
  annotation (
    Line(
