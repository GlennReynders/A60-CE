...
model SwWindowResponse "shortwave window respones for greybox models"
  ...
  Modelica.Blocks.Interfaces.RealOutput iSolDf
...
equation
  ...
  connect(SwAbsDifProd.y, add.u1) annotation (Line(
      ...
      color={0,0,127},
      smooth=Smooth.None));
  connect(SwTransDirProd.y, iSolDir) annotation (Line(
      points={{-7,26.7},{42.5,26.7},{42.5,54},{100,54}},
      color={0,0,127},
      smooth=Smooth.None));
  connect(SwTransDifProd.y, iSolDf) annotation (Line(
      points={{45,24.7},{45,-3.65},{100,-3.65},{100,-30}},
      color={0,0,127},
      smooth=Smooth.None));
  annotation (
