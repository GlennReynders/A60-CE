within CE.Models;
model RC_SR1 "2Zone RC model for Annex SR1"
...
parameter Real abs5WD =  0;
 ...
 parameter Real     hwD =  102.9247748;
 parameter Real     hflD =  197.8244681;
 parameter Real     hwiD =  420.0689935;
 parameter Real     infD =  41.32192394;
 parameter Real     UwD =  28.13148934;
 parameter Real     UflD =  20.11603563;

parameter Real abs1EN =  1.1480832;
parameter Real abs1NN =  1.7360772;
parameter Real abs1SN =  0.5700552;
parameter Real abs1WN =  0;
parameter Real abs2EN = 1.1480832;
...
parameter Real abs5EN = 1.1480832;
parameter Real abs5NN = 1.7360772;
parameter Real abs5SN = 0.5700552;
parameter Real abs5WN = 0;

 parameter Real     CiN =  1.034E+06;
 parameter Real     CwN =  9.154E+06;
 parameter Real     CwiN =  4.176E+07;
 parameter Real     f1N =  0.1;
 parameter Real     f2N =  0.1;
 parameter Real     f3N =  0.7;

 parameter Real     hwN =  410.4015232;
 parameter Real     hwiN =  674.6477486;
 parameter Real     infN =  18.51690538;
 parameter Real     UwN =  57.34025445;

 parameter Real     CfiD =  22651975.5;
 parameter Real     CfiN =  22651975.5;
 parameter Real     f5D =  0.1;
 parameter Real     f5N =  0.1;
 parameter Real     UfDN =  188.4105882;
