within CE.Models;
model RC_D2 "2Zone RC model for Annex D2"
...
parameter Real AwinENight = 2.90;
...
parameter Real abs5WD =  0.85164;
 ...
 parameter Real     CwD =  2.015E+07;
 parameter Real     CwiD =  1.468E+07;
 parameter Real     CflD =  2.99E+07;
 ...
 parameter Real     hwD =  263.1444444;
 parameter Real     hflD =  147.2186235;
 parameter Real     hwiD =  264.225256;
 parameter Real     infD =  71.04648438;
 parameter Real     UwD =  290.7440619;
 parameter Real     UflD =  505.0416667;
...
parameter Real abs5WN = 1.1241648;
 ...
 parameter Real     CwN =  2.909E+07;
 parameter Real     CwiN =  5.133E+07;
 parameter Real     f1N =  0.1;
 parameter Real     f2N =  0.1;
 parameter Real     f3N =  0.7;

 parameter Real     hwN =  822.0004988;
 parameter Real     hwiN =  459.9402405;
 parameter Real     infN =  66.1840276;
 parameter Real     UwN =  894.685837;

 parameter Real     CfiD =  18594327;
 parameter Real     CfiN =  18594327;
 parameter Real     f5D =  0.1;
 parameter Real     f5N =  0.1;
 parameter Real     UfDN =  188.8284967;
